pub const FEEDS_JSON: &str = r#"{
  ...
  "bsc": {
    "baseUrl": "https://bsc-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "DOT/USD",
  ...
  "avalanche": {
    "baseUrl": "https://avalanche-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "SAND/USD",
  ...
  "base": {
    "baseUrl": "https://base-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "AXL/USD",
  ...
  "starknet": {
    "baseUrl": "https://starknet-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "ETH/USD",
  ...
  "linea": {
    "baseUrl": "https://linea-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "ETH/USD",
  ...
  "mantle": {
    "baseUrl": "https://mantle-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "ETH/USD",
  ...
  "scroll": {
    "baseUrl": "https://scroll-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "WSTETH/ETH",
  ...
  "zksync": {
    "baseUrl": "https://zksync-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "PEPE/USD",
  ...
  "celo": {
    "baseUrl": "https://celo-mainnet.infura.io/v3",
    "feeds": [
      {
        "name": "CUSD/USD",
